...
ROI_OCCNET_HEAD_REGISTRY = Registry("ROI_VOXEL_HEAD")


def occnet_rcnn_loss(pred_occnet_logits, instances, loss_weight=1.0):
...
def build_occnet_head(cfg, input_shape):
